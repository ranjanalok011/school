...
class Registration extends App_Controller {
	...
	$this->form_validation->set_rules('bpl', 'BPL Number', 'xss_clean|trim');
	...
	$this->form_validation->set_rules('f_email', 'Father\'s E-mail ID', 'xss_clean|trim|valid_email');
	...
	$this->form_validation->set_rules('via', 'Via', 'xss_clean|trim');
